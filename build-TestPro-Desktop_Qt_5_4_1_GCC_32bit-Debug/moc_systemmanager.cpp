...
QT_MOC_LITERAL(4, 28, 7) // "getInfo"
    ...
    "SystemManager\0newInfo\0\0info\0getInfo"
};
...
void SystemManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SystemManager::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SystemManager::newInfo)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SystemManager::newInfo(QString _t1)
{
