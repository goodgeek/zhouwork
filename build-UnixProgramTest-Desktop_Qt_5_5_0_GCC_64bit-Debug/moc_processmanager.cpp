...
#include "../UnixProgramTest/processmanager.h"
...
QT_MOC_LITERAL(1, 15, 10), // "setMessage"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "mesg"
QT_MOC_LITERAL(4, 32, 10) // "getIdInfos"

    },
    "ProcessManager\0setMessage\0\0mesg\0"
    "getIdInfos"
};
...
void ProcessManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ProcessManager::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProcessManager::setMessage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ProcessManager::setMessage(QString _t1)
{
